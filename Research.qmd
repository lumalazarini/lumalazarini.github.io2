...
Files were then tidied and prepared for mapping in ArcGIS Pro. Below is an example of the file including dakota bottoms for mapping. This file only includes the well ID, latitude, longitude, and the height the aquifer bottom was recorded in feet. 
